...
snp_data <- snpsById(SNPlocs.Hsapiens.dbSNP155.GRCh38, rsid_list, ifnotfound="drop")
...
# 保存结果文件和日志文件
output_dir <- file.path(dirname(file_path), "GRCh38_processed_results")
...
reference_version <- "SNPlocs.Hsapiens.dbSNP155.GRCh38"
